...
| Channel | Node | git | `gh` |
| --- | --- | --- | --- |
| **Installer script** | you provide **24.15.0+** — the installer is a Node program, never installs Node, and hands the package to npm | you provide it | you provide it |
| **npm, bun, pnpm, Yarn** | you provide **24.15.0+** | you provide it | you provide it |
...
application floor: application and package channels need Node `24.15.0` or
