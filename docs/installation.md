...
| | Install | Upgrade | |
| --- | --- | --- | --- |
| **Installer script** (macOS, Linux, WSL) | `curl --proto '=https' --tlsv1.2 -fsSL https://www.looptroop.ovh/install \| sh` | run it again | ✅ |
...
```bash
curl --proto '=https' --tlsv1.2 -fsSL https://www.looptroop.ovh/install | sh -s -- --binary
```
