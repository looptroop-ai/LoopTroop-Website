...
test('published POSIX installer recipes require HTTPS throughout redirects', async () => {
  for (const file of ['docs/installation.md', 'docs/index.md', 'docs/getting-started.md', 'web.html']) {
